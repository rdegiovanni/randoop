...
public class ForwardGenerator extends AbstractGenerator {
  ...
  public ForwardGenerator(
          ...
          RandoopListenerManager listenerManager,        // re-added
          Set<ClassOrInterfaceType> classesUnderTest) {
    this(operations, sideEffectFreeMethods, limits,
            componentManager, /*stopper=*/ null,
            listenerManager, classesUnderTest);
  }
